	...
	private void specialCastlingWhite(Square[][] squares, List<PositionChessboard> list) {
		...
		if(rookA != null && rookA.getTypePiece() == TypePiece.ROOK && rookA.getCountMovements() == 0){
			if(MovementUtils.movementAvailableLeft(3, PositionChessboard.E1, squares, Boolean.FALSE, getPlayer()).size() == 3){
				...
				if(validatePassingSquaresOfCastlingThreatenedEnemy(D1, squares, TypePlayer.W) 
						&& validatePassingSquaresOfCastlingThreatenedEnemy(C1, squares, TypePlayer.W)) 
		...
		if(rookH != null && rookH.getTypePiece() == TypePiece.ROOK && rookH.getCountMovements() == 0){
			if(MovementUtils.movementAvailableRight(2, PositionChessboard.E1, squares, Boolean.FALSE, getPlayer()).size() == 2){
				...
				if(validatePassingSquaresOfCastlingThreatenedEnemy(G1, squares, TypePlayer.W) 
						&& validatePassingSquaresOfCastlingThreatenedEnemy(F1, squares, TypePlayer.W)) 
	...
	private void specialCastlingBlack(Square[][] squares, List<PositionChessboard> list) {
		...
		if(rookA != null && rookA.getTypePiece() == TypePiece.ROOK && rookA.getCountMovements() == 0){
			if(MovementUtils.movementAvailableLeft(3, PositionChessboard.E8, squares, Boolean.FALSE, getPlayer()).size() == 3){
				...
				if(validatePassingSquaresOfCastlingThreatenedEnemy(D8, squares, TypePlayer.B) 
						&& validatePassingSquaresOfCastlingThreatenedEnemy(C8, squares, TypePlayer.B)) 
		...
		if(rookH != null && rookH.getTypePiece() == TypePiece.ROOK && rookH.getCountMovements() == 0){
			if(MovementUtils.movementAvailableRight(2, PositionChessboard.E8, squares, Boolean.FALSE, getPlayer()).size() == 2){
				...
				if(validatePassingSquaresOfCastlingThreatenedEnemy(G8, squares, TypePlayer.B) 
						&& validatePassingSquaresOfCastlingThreatenedEnemy(F8, squares, TypePlayer.B)) 
				list.add(PositionChessboard.G8);
			}
		}
	}

	private boolean validatePassingSquaresOfCastlingThreatenedEnemy(PositionChessboard posVerify, Square[][] sq, TypePlayer type) {
		boolean isCheck;
		if(type == TypePlayer.W){
			Piece kingTemp = sq[E1.getLetter()][E1.getNumber()].getPiece();
			...
			Piece kingTemp = sq[E8.getLetter()][E8.getNumber()].getPiece();
